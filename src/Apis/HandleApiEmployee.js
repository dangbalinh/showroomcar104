...
const getEmployeeById = async(id) =>{
    return await authAxiosInstance.get(`/users/employees/${id}`);
}
...
const getEmployeeByPageIndex = async (index) => {
    return await authAxiosInstance.get(`/users/employees?pageIndex=${index}`);
};

const deleteEmployee = async (id) => {
    return await authAxiosInstance.delete(`/users/employees/${id}`);
};

const createEmployee = async (data) => {
    return await authAxiosInstance.post("/users/employees", data);
}

const updateEmployee = async (id, data) => {
    return await authAxiosInstance.put(`/users/employees/${id}`, data)
}
