...
const ForgetPass = (props) => {
  ...
  return (
    ...
    <form className={classes.form}>
                <h2>Quên mật khẩu?</h2>
                <p style={{color: "#c3aeae",padding: "20px 0",fontSize:"18px", textAlign:"center"}}>Đừng lo lắng hãy nhập vào email của bạn và bắt đầu thiết lập mật khẩu mới!</p>
                <p>
                ...
                <p style={{ textAlign:"center", fontSize:"16px"}}>
                    ...
                    >Gửi Email</button><br/>
                    <p className={classes.direct} onClick={handleClick}>Quay về đăng nhập</p>
                </p>
